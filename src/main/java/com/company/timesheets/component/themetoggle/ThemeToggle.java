package com.company.timesheets.component.themetoggle;
...
public class ThemeToggle extends Component implements ClickNotifier<ThemeToggle>,
     ...
     * given text.
     * <p>
     * This method also sets or removes this component's <code>theme=icon</code>
     * attribute based on whether this component contains only an icon after this
     * operation or not.
     *
    ...
    /**
     * Gets the component that is defined as the icon of this component.
     *
     * @return the icon of this component, or <code>null</code> if the icon is not
     * set
     */
    @Nullable
    ...
    /**
     * Get the state for the autofocus property of this component.
     * <p>
     * This property is not synchronized automatically from the client side, so
     * the returned value may not be the same as in client side.
     *
     * @return the {@code autofocus} property from this component
     */
    ...
    /**
     * Set this component to be input focused when the page loads.
     *
    ...
    /**
     * Gets browser's local storage key to store theme name.
     *
     * @return browser's local storage key to store theme name.
     */
    ...
    /**
     * Sets browser's local storage key to store theme name.
     *
     * @param storageKey browser's local storage key to store theme name
     */
    ...
    private void updateThemeAttribute() {
        // Add theme attribute "icon" when this component contains only an icon to
    ...
    /**
     * Adds a theme variant change listener to this component.
     *
    ...
    /**
     * Event fired when a theme variant is changed.
     */
